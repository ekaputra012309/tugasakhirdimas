                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5 class="m-0">Table Jabatan</h5>
                            <a href="/admin/jabatan/add" type="button" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Add</a>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#example').on('click', '.edit-btn', function() {
            ...
            window.location.href = '/admin/jabatan/edit?id=' + encodedId; // Pass the encoded ID as a parameter
        ...
        $('#example').on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '/api/jabatan/' + id, // Specify the delete endpoint with the ID
                        type: 'DELETE',
                        success: function(response) {
